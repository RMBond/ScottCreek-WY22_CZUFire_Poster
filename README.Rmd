...
5. The <span style="color:purple">*Scott_Creek_Weir_Hydrolab_20210101_to_20210622.csv*</span> datafile contains a snippbet (incomplete dataset) of the water quality data collected by the HYDROLAB (S/N 66279, model DS5X). The unit is installed directly above the weir. It collects depth, temp, salinity, turbidity, (and other) every half hour. Note there is some column renaming done before importing the dataset into R. Data range from 1/1/2021 to 6/22/21. <span style="color:red">*It may need some QC.*</span> 
